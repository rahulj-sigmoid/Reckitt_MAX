...
zz = zz[(zz['Month Won or Lost']>'2022-12') & (zz['Month Won or Lost']<'2024-01')].copy().reset_index(drop=True)
zz = zz.fillna(0)
...
zz['Month'] = zz['Month'].apply(lambda x: x[:3] + " '23")
...
fig.update_layout(
    title='Hospitals Won and Lost with Net Rolling Hospitals Won - 2023',
